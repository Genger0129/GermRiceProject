...
namespace NFine.Code.WeChat
{
    ...
    public class ResponseMessageBase : MessageBase
    {
        ...
        public static ResponseMessageBase CreateFromRequestMessage(IRequestMessageBase requestMessage, ResponseMsgType msgType)
        {
            ...
            try
            {
                switch (msgType)
                {
                    ...
                    case ResponseMsgType.Transfer_Customer_Service:
                        ...
                        break;
                    default:
                        throw new ApplicationException(string.Format("ResponseMsgType没有为 {0} 提供对应处理程序。", msgType), new ArgumentOutOfRangeException());
                }
            ...
            {
                throw new ApplicationException("CreateFromRequestMessage过程发生异常", ex);
            }
        ...
        public static T CreateFromRequestMessage<T>(IRequestMessageBase requestMessage) where T : ResponseMessageBase
        {
            ...
            {
                throw new ApplicationException("ResponseMessageBase.CreateFromRequestMessage<T>过程发生异常！", ex);
            }
        }
        ...
        /// <returns></returns>
        public static ResponseMessageBase CreateFromResponseXml(string xml)
        {
            try
            {
            ...
            {
                throw new ApplicationException("ResponseMessageBase.CreateFromResponseXml<T>过程发生异常！" + ex.Message, ex);
            }
        }
    }
}
